...
namespace SmallLabyWpfPlayer.ServiceRefSmallLaby {
    ...
    public interface ISmallLaby {
        ...
        SmallLabyWpfPlayer.ServiceRefSmallLaby.GetPositionResponse GetPosition(SmallLabyWpfPlayer.ServiceRefSmallLaby.GetPositionRequest request);
    ...
    public partial class SmallLabyClient : System.ServiceModel.ClientBase<SmallLabyWpfPlayer.ServiceRefSmallLaby.ISmallLaby>, SmallLabyWpfPlayer.ServiceRefSmallLaby.ISmallLaby {
        ...
        SmallLabyWpfPlayer.ServiceRefSmallLaby.GetPositionResponse SmallLabyWpfPlayer.ServiceRefSmallLaby.ISmallLaby.GetPosition(SmallLabyWpfPlayer.ServiceRefSmallLaby.GetPositionRequest request) {
            return base.Channel.GetPosition(request);
        }
        
        public int GetPosition(int player_id, out int y) {
            SmallLabyWpfPlayer.ServiceRefSmallLaby.GetPositionRequest inValue = new SmallLabyWpfPlayer.ServiceRefSmallLaby.GetPositionRequest();
            inValue.player_id = player_id;
            SmallLabyWpfPlayer.ServiceRefSmallLaby.GetPositionResponse retVal = ((SmallLabyWpfPlayer.ServiceRefSmallLaby.ISmallLaby)(this)).GetPosition(inValue);
            y = retVal.y;
            return retVal.x;
        }
        
        public System.Threading.Tasks.Task<SmallLabyWpfPlayer.ServiceRefSmallLaby.GetPositionResponse> GetPositionAsync(SmallLabyWpfPlayer.ServiceRefSmallLaby.GetPositionRequest request) {
